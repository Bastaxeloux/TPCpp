...
// Définition de la fonction `setupCommands()`
void setupCommands() {
    ...
    // Joue un média (ouvre le fichier)
    ...
    // Suppression d'un média ou groupe
    ...
    // Supprimer un média d'un groupe
    ...
    // Vérifier si un média est dans un groupe
